...
- [ ] Task: Research TikTok and Spotify deep link URI schemes
    - [ ] Write unit tests for basic URL detection (Red Phase)
    - [ ] Document discovered schemes in `tech-stack.md` if necessary
